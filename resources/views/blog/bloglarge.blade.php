                                ...
                                <div class="col-xl-12">
                                        ...
                                        <div class="text-holder">
                                            <h3>
                                                <a href="blog-single.html">
                                                    University of Educamb Award 4 Honorary Degrees
                                                </a>
                                            </h3>
                                            <div class="text">
                                                <p>Duty obligations of business frequently occur pleasures that cannot
                                                    foresee the pain and trouble foresee the pain and trouble enjoy that
                                    ...
                                    <div class="single-blog-style1">
                                        ...
                                        <div class="text-holder">
                                            ...
                                            <div class="text">
                                                <p>Beguiled and demoralized by charms of pleasure of the same through
                                                    shrinking from toil denounce with righteous indignation and dislike
                                    ...
                                    <div class="single-blog-style1">
                                        ...
                                        <div class="text-holder">
                                            ...
                                            <div class="text">
                                                <p>These cases are perfectly simple easy to distinguish. In a free hour
                                                    welcomed and every pain avoided so blinded by desire, that they
                                                    cannot foresee...</p>
                                            </div>
                                            <div class="bottom-box">
                                                <div class="btn-box">
                                                ...
                                                <div class="meta-info">
                                                    <ul>
                                                        <li>
                                                            <span class="icon-calendar"></span>
                                                            <a href="#">Oct 28, 2022</a>
                                                        </li>
                                                        <li>
                                                            <span class="icon-user"></span>
                                                            <a href="#">James Olivia</a>
                                                        </li>
                                                        <li>
                                                            <span
                                                                class="icon-chat-comment-oval-speech-bubble-with-text-lines"></span>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <ul class="styled-pagination clearfix">
                                        <li class="arrow prev">
                                            <a href="#"><span class="icon-right-arrow-1 left"></span></a>
                                        </li>
                                        <li class="active"><a href="#">01</a></li>
                                        <li><a href="#">02</a></li>
                                        <li class="arrow next">
                                            <a href="#"><span class="icon-right-arrow-1 right"></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
